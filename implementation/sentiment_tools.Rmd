...
twitter_sentiment$rating_binary[twitter_sentiment$rating >= 3] <- "1"
twitter_sentiment$rating_binary[twitter_sentiment$rating < 3] <- "0"
...
parlvote_sentiment$rating_binary[parlvote_sentiment$rating >= 3] <- "1"
parlvote_sentiment$rating_binary[parlvote_sentiment$rating < 3] <- "0"
