...
parlvote_corr_norm <- get_sentiment(parlvote_corr, c("afinn", "lsd", "vader"), normalize="relative", get_tokens=FALSE)
...
### CONFIG1 
reviews_config1_sentiment_norm <- get_sentiment(reviews_config1, c("afinn","lsd", "vader"), normalize="relative", get_tokens=FALSE)
twitter_config1_sentiment_norm <- get_sentiment(twitter_config1, c("afinn","lsd", "vader"), normalize="relative", get_tokens=FALSE)
parlvote_config1_sentiment_norm <- get_sentiment(parlvote_config1, c("afinn","lsd", "vader"), normalize="relative", get_tokens=FALSE)
amazon_config1_sentiment_norm <- get_sentiment(amazon_config1, c("afinn", "lsd", "vader"), normalize="relative", get_tokens=FALSE)
finance_config1_sentiment_norm <- get_sentiment(finance_config1, c("afinn", "lsd", "vader"), normalize="relative", get_tokens=FALSE)
...
### CONFIG2
reviews_config2_sentiment_norm <- get_sentiment(reviews_config2, c("afinn","lsd", "vader"), normalize="relative", get_tokens=FALSE)
twitter_config2_sentiment_norm <- get_sentiment(twitter_config2, c("afinn","lsd", "vader"), normalize="relative", get_tokens=FALSE)
parlvote_config2_sentiment_norm <- get_sentiment(parlvote_config2, c("afinn","lsd", "vader"), normalize="relative", get_tokens=FALSE)
amazon_config2_sentiment_norm <- get_sentiment(amazon_config2, c("afinn", "lsd", "vader"), normalize="relative", get_tokens=FALSE)
finance_config2_sentiment_norm <- get_sentiment(finance_config2, c("afinn", "lsd", "vader"), normalize="relative", get_tokens=FALSE)
...
### CONFIG3 
reviews_config3_sentiment_norm <- get_sentiment(reviews_config3, c("afinn","lsd", "vader"), normalize="relative", get_tokens=FALSE)
twitter_config3_sentiment_norm <- get_sentiment(twitter_config3, c("afinn","lsd", "vader"), normalize="relative", get_tokens=FALSE)
parlvote_config3_sentiment_norm <- get_sentiment(parlvote_config3, c("afinn","lsd", "vader"), normalize="relative", get_tokens=FALSE)
amazon_config3_sentiment_norm <- get_sentiment(amazon_config3, c("afinn", "lsd", "vader"), normalize="relative", get_tokens=FALSE)
finance_config3_sentiment_norm <- get_sentiment(finance_config3, c("afinn", "lsd", "vader"), normalize="relative", get_tokens=FALSE)
...
# BINARY VERSIONS
finance_bin_norm <- get_sentiment(finance_bin, c("afinn", "lsd", "vader"), normalize="relative", get_tokens=FALSE)
finance_bin_norm1 <- get_sentiment(finance_bin, c("afinn", "lsd", "vader"), normalize="afinn", get_tokens=FALSE)
write.csv(finance_bin_norm, "datasets/sentiment_scores/finance_bin_norm.csv", row.names = FALSE)
write.csv(finance_bin_norm1, "datasets/sentiment_scores/finance_bin_norm1.csv", row.names = FALSE)

finance_bin1_norm <- get_sentiment(finance_bin1, c("afinn", "lsd", "vader"), normalize="relative", get_tokens=FALSE)
finance_bin1_norm1 <- get_sentiment(finance_bin1, c("afinn", "lsd", "vader"), normalize="afinn", get_tokens=FALSE)
write.csv(finance_bin1_norm, "datasets/sentiment_scores/finance_bin1_norm.csv", row.names = FALSE)
write.csv(finance_bin1_norm1, "datasets/sentiment_scores/finance_bin1_norm1.csv", row.names = FALSE)

finance_bin2_norm <- get_sentiment(finance_bin2, c("afinn", "lsd", "vader"), normalize="relative", get_tokens=FALSE)
finance_bin2_norm1 <- get_sentiment(finance_bin2, c("afinn", "lsd", "vader"), normalize="afinn", get_tokens=FALSE)
write.csv(finance_bin2_norm, "datasets/sentiment_scores/finance_bin2_norm.csv", row.names = FALSE)
write.csv(finance_bin2_norm1, "datasets/sentiment_scores/finance_bin2_norm1.csv", row.names = FALSE)

finance_bin3_norm <- get_sentiment(finance_bin3, c("afinn", "lsd", "vader"), normalize="relative", get_tokens=FALSE)
finance_bin3_norm1 <- get_sentiment(finance_bin3, c("afinn", "lsd", "vader"), normalize="afinn", get_tokens=FALSE)
write.csv(finance_bin3_norm, "datasets/sentiment_scores/finance_bin3_norm.csv", row.names = FALSE)
write.csv(finance_bin3_norm1, "datasets/sentiment_scores/finance_bin3_norm1.csv", row.names = FALSE)

twitter_bin_norm <- get_sentiment(twitter_bin, c("afinn", "lsd", "vader"), normalize="relative", get_tokens=FALSE)
twitter_bin_norm1 <- get_sentiment(twitter_bin, c("afinn", "lsd", "vader"), normalize="afinn", get_tokens=FALSE)
write.csv(twitter_bin_norm, "datasets/sentiment_scores/twitter_bin_norm.csv", row.names = FALSE)
write.csv(twitter_bin_norm1, "datasets/sentiment_scores/twitter_bin_norm1.csv", row.names = FALSE)

twitter_bin1_norm <- get_sentiment(twitter_bin1, c("afinn", "lsd", "vader"), normalize="relative", get_tokens=FALSE)
twitter_bin1_norm1 <- get_sentiment(twitter_bin1, c("afinn", "lsd", "vader"), normalize="afinn", get_tokens=FALSE)
write.csv(twitter_bin1_norm, "datasets/sentiment_scores/twitter_bin1_norm.csv", row.names = FALSE)
write.csv(twitter_bin1_norm1, "datasets/sentiment_scores/twitter_bin1_norm1.csv", row.names = FALSE)

twitter_bin2_norm <- get_sentiment(twitter_bin2, c("afinn", "lsd", "vader"), normalize="relative", get_tokens=FALSE)
twitter_bin2_norm1 <- get_sentiment(twitter_bin2, c("afinn", "lsd", "vader"), normalize="afinn", get_tokens=FALSE)
write.csv(twitter_bin2_norm, "datasets/sentiment_scores/twitter_bin2_norm.csv", row.names = FALSE)
write.csv(twitter_bin2_norm1, "datasets/sentiment_scores/twitter_bin2_norm1.csv", row.names = FALSE)

twitter_bin3_norm <- get_sentiment(twitter_bin3, c("afinn", "lsd", "vader"), normalize="relative", get_tokens=FALSE)
twitter_bin3_norm1 <- get_sentiment(twitter_bin3, c("afinn", "lsd", "vader"), normalize="afinn", get_tokens=FALSE)
write.csv(twitter_bin3_norm, "datasets/sentiment_scores/twitter_bin3_norm.csv", row.names = FALSE)
write.csv(twitter_bin3_norm1, "datasets/sentiment_scores/twitter_bin3_norm1.csv", row.names = FALSE)
```

```{r}
finance_config2_sentiment_norm
finance_config2_sentiment_norm1
```
...
write.csv(parlvote_corr_norm, "datasets/sentiment_scores/parlvote_corr_norm.csv", row.names = FALSE)
...
reviews_discrete <- get_discrete(reviews_sentiment_norm, c("afinn","vader","lsd"), "rating")
twitter_discrete <- get_discrete(twitter_sentiment_norm, c("afinn","vader","lsd"), "rating")
parlvote_discrete <- get_discrete(parlvote_sentiment_norm, c("afinn","vader","lsd"), "rating")
amazon_discrete <- get_discrete(amazon_sentiment_norm, c("afinn","vader","lsd"), "rating")
...
finance_afinn.acc <- get_statistics(finance_discrete, "afinn")[[1]][1]
finance_afinn.stats <- get_statistics(finance_discrete, "afinn")[2]

finance_lsd.acc <- get_statistics(finance_discrete, "lsd")[[1]][1]
finance_lsd.stats <- get_statistics(finance_discrete, "lsd")[2]

finance_vader.acc <- get_statistics(finance_discrete, "vader")[[1]][1]
finance_vader.stats <- get_statistics(finance_discrete, "vader")[2]
