...
write.csv(parlvote_sentiment, "datasets/sentiment_data/parlvote_sentiment_norm1.csv", row.names = FALSE)
write.csv(amazon_sentiment, "datasets/sentiment_data/amazon_sentiment_norm1.csv", row.names = FALSE)
write.csv(twitter_sentiment, "datasets/sentiment_data/twitter_sentiment_norm1.csv", row.names = FALSE)
write.csv(reviews_sentiment, "datasets/sentiment_data/reviews_sentiment_norm_norm1.csv", row.names = FALSE)
```
