...
twitter_bin <- readRDS(file="datasets/config_1/twitterbin_config_base.rds")
finance_bin <- readRDS(file="datasets/config_1/finbin_config_base.rds")
...
twitter_bin2 <- readRDS(file="datasets/config_2/twitterbin_config_base.rds")
finance_bin2 <- readRDS(file="datasets/config_2/finbin_config_base.rds")
...
twitter_bin3 <- readRDS(file="datasets/config_3/twitterbin_config_base.rds")
finance_bin3 <- readRDS(file="datasets/config_3/finbin_config_base.rds")
