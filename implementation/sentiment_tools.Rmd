...
```
```{r}
#reviews.afinn$lsd_total <- reviews_50$lsd

#reviews.afinn$text <- reviews_50$text
#reviews.afinn$rating <- reviews_50$rating


#reviews.afinn
#reviews_50$afinn <- reviews.afinn$afinn_total
