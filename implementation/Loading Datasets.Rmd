...
#filter for only rating and text columns and only rows that have an English tag
for (i in 0:5){
hold<- subset(reviews, rating == i| language=="english", select = c("text","rating"))

#combine them into a dataframe with 1000 entries and an equal rating distribution 
